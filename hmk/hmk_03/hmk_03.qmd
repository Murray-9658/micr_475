...
I created an Excel sheet containing the brand, color, and price of drills. I then converted this sheet to a .csv file so that I can be analyzed in RStudio.
